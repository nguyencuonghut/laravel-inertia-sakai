            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Honghafeed HRM!</div>
                    ...
                    <div>
                        <form @submit.prevent="submit">
                            ...
                            <InputText id="email" type="text" placeholder="Email" class="w-full md:w-[30rem] mb-4" v-model="form.email" />
                            <InputError class="mb-2" :message="form.errors.email" />

                            <label for="password" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Mật khẩu</label>
                            <Password id="password" v-model="form.password" placeholder="Mật khẩu" :toggleMask="true" class="mb-4" fluid :feedback="false"></Password>
                            <InputError class="mt-2" :message="form.errors.password" />

                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                <div class="flex items-center">
                                    <Checkbox v-model="form.remember" id="remember" name="remember" binary class="mr-2"></Checkbox>
